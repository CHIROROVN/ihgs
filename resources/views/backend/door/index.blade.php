        ...
        <table id="table">
          ...
          @else  
            @foreach($doorcards as $doorcard)
              <tr>
                <td align="center" style="width: 120px;"><input value="削除" type="button" class="btn btn-primary btn-xs" name="btnDelete" id="btnDelete" value="削除" type="button" class="btn btn-primary btn-xs" onclick="if (confirm('Are you sure delete')) {location.href='{{ asset('door/delete/' . $doorcard->td_dataname) }}' }"></td>
