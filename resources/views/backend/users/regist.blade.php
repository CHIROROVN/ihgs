...
<table width="960" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
	<tr>
	  <td width="150%" class="col_1">■敷島堂 Website 管理画面　＞　「ユーザー」管理　＞　新規登録</td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	</tr>
	  ...
	  <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
		<tbody>
		  <tr>
			...
			<td>
				<input name="u_name" type="text" id="u_name" size="40" value="{{old('u_name')}}">
		  ...
		  <tr>
			...
			<td>
				<input name="u_login" type="text" id="u_login" value="{{old('u_login')}}">
		  ...
		  <tr>
			...
			<td><input type="checkbox" name="u_flag" id="u_flag" value="1" @if(old('u_flag') == 1) checked @endif>
			  一時的に無効にする</td>
		  </tr>
		</tbody>
	  </table></td>
