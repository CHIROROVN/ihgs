                  ...
                  <table class="table table-bordered mar-bottom15">
                    ...
                    <tr>
                      ...
                      <td class="col-md-9">
                        ...
                        <div>
                          <input name="u_power02" value="2" id="u_power02" type="checkbox" @if(old('u_power02') == 2) checked @endif > 「タイムカード」の管理
                        </div>
                        <div>
                          <input name="u_power03" value="3" id="u_power03" type="checkbox" @if(old('u_power03') == 3) checked @endif > 「入退出」の管理
                        </div>
                        <div>
                          <input name="u_power04" value="4" id="u_power04" type="checkbox" @if(old('u_power04') == 4) checked @endif > 「PCログ」の管理
                        </div>
                        <div>
                          <input name="u_power05" value="5" id="u_power05" type="checkbox" @if(old('u_power05') == 5) checked @endif > 部課マスタの管理
                        </div>
                        <div>
