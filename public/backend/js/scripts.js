...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($.fn.dcAccordion) {
            $('#nav-accordion li ul').dcAccordion({
                eventType: 'click',
                autoClose: true,
                saveState: true,
                disableLink: true,
    ...
    if($(document).height() > $("body").height()){
      $(".copyrights").addClass("copyright-fixed");
    } 
    
    $(".pages_agile_info_w3l").css("height",$(document).height());
    $(".over_lay_agile_pages_w3ls").css("height",$(document).height());
