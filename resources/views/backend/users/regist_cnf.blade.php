...
<table width="960" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
	<tr>
	  <td width="150%" class="col_1">■敷島堂 Website 管理画面　＞　「ユーザー」管理　＞　登録確認</td>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	</tr>
	...
	<tr>
	  <td align="center"><input type="button" id="btn-save" onClick="location.href='{{route('backend.users.regist_save')}}'" value="保存する">
	  <input type="button" id="btn-back" onClick="location.href='{{route('backend.users.regist_back')}}'" value="戻って修正する"></td>
	</tr>
	<tr>
	  <td align="center">&nbsp;</td>
	</tr>
